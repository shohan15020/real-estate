        ...
        >
            ...
            <div className="grid max-w-6xl grid-cols-1 px-6 mx-auto lg:px-8 md:grid-cols-2 md:divide-x ">
                ...
                <div  data-aos="fade-right"  className="py-6 md:py-0 md:px-6">
                    ...
                    <div className="space-y-4 text-white">
                        <p className="flex items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-5 h-5 mr-2 sm:mr-6 text-primary ">
                ...
                <form  data-aos="fade-left" className="border-none rounded-lg flex flex-col py-6 space-y-6 md:px-6 px-2 backdrop-blur-xl bg-white/30 ">
                    ...
                    <button type="button" className=" font-medium text-white text-lg md:text-xl md:pb-2 md:px-4 py-1 px-2 rounded-lg bg-primary text-center">Submit</button>
                </form>
            </div>
