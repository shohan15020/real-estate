    ...
    <div className="container mx-auto mt-8 mb-12">
      ...
      <div data-aos="fade-down" className="max-w-3xl mx-auto border-2  shadow-md rounded-lg overflow-hidden flex flex-col ">
        ...
        <div className="p-6 flex flex-col justify-between ">
          ...
          <div>
            <h2 className="text-3xl font-bold text-gray-800  mb-4">{segment_name}</h2>

            <h2 className="text-2xl font-medium text-gray-800 d mb-4">{estate_title}</h2>
            ...
            <p className="text-lg text-gray-600  mb-2">Area: {area}</p>
            <p className="text-lg text-gray-600  mb-4">Location: {location}</p>
          </div>


          <div className="mt-4">
            <p className="text-xl font-bold text-gray-800 mb-4">Facilities:</p>

            <ul className="text-lg text-gray-600   list-disc  flex gap-4">
